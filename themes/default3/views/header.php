...
<header class="navbar navbar-inverse navbar-fixed-top bs-docs-nav row">
   ...
   <div class="container-fluid col-xs-8 col-xs-offset-1" id="navfluid" >
       ...
       <div class="collapse navbar-collapse" id="navigationbar">
           <ul class="nav navbar-nav">
               ...
               <li> 
						<div class="btn-group btn-header-group">
...
<div class="alert alert-info" role="alert">
  <strong>Clasificados, Anuncios Gratis en Dominicana. Compra, Vende, Renta, Alquila en Anuncio.DO </strong>
</div>
</div>
